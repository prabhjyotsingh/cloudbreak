...
public class CloudNetworkCreationServiceTest {
    ...
    public void testCreatedCloudNetworkShouldCreateANewCloudNetwork() throws Exception {
        ...
        when(cloudNetworkCreationRequestFactory.create(ENV_NAME, credential, CLOUD_PLATFORM, REGION, NETWORK_CIDR, SUBNET_CIDRS))
        ...
        CreatedCloudNetwork actual = underTest.createCloudNetwork(ENV_NAME, credential, CLOUD_PLATFORM, REGION, NETWORK_CIDR, SUBNET_CIDRS);

        verify(cloudNetworkCreationRequestFactory).create(ENV_NAME, credential, CLOUD_PLATFORM, REGION, NETWORK_CIDR, SUBNET_CIDRS);
    ...
    public void testCreatedCloudNetworkShouldThrowExceptionWhenTheEventBusReturnsWithFailedStatus() throws Exception {
        ...
        underTest.createCloudNetwork(ENV_NAME, credential, CLOUD_PLATFORM, REGION, NETWORK_CIDR, SUBNET_CIDRS);
