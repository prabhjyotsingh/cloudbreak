...
public class CloudNetworkCreationService {
    ...
    public CreatedCloudNetwork createCloudNetwork(String envName, Credential credential, String cloudPlatform, String region, String networkCidr,
